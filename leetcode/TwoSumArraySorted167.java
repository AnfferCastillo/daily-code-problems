...
public class TwoSumArraySorted167 {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(TwoSumArraySorted167.binarySearch(new int[]{2, 7, 11, 15},
    // 1, 0, 4));
    /*
     * TwoSumArraySorted167.print(TwoSumArraySorted167.twoSum(new int[] {-1, 0, 2},
     * 1)); // [1, 3]
     */
    // TwoSumArraySorted167.print(TwoSumArraySorted167.twoSum(new int[] {2, 7, 11,
    // 15}, 9)); // [1,2]
    /*
     * TwoSumArraySorted167.print(TwoSumArraySorted167.twoSum(new int[] {-1, 0},
     * -1)); //[1,2]
     */
    // TwoSumArraySorted167.print(TwoSumArraySorted167.twoSum(new int[] {-1, 0},
    // 8)); //[0,0]*/
